...
const UserProfile = () => {
    ...
    const updateDetails = async (e) => {
        ...
        try {
            console.log(data);
            const url = "https://property-sys-backend.herokuapp.com/api/updateprofile";
    ...
    const updatePassword = async (e) => {
        ...
        try {
            ...
            const url = "https://property-sys-backend.herokuapp.com/api/updateprofile/update-password";
    ...
    const addAuthorizedUser = async (e) => {
        ...
        try {
            ...
            const url = "https://property-sys-backend.herokuapp.com/api/updateprofile/add-authorized-user";
    ...
    const removeAuthorizedUser = async (e) => {
        ...
        try {
            console.log(authorizedEmail);
            const url = "https://property-sys-backend.herokuapp.com/api/updateprofile/remove-authorized-user";
            const { data: res } = await axios.post(url, authorizedEmail).then((response) => {
                console.log(response);
                GetAuthUserManually();
            });
